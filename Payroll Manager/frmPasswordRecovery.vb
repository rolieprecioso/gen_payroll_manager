...
Public Class frmPasswordRecovery
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        Try
            ...
            'Dim con As New SqlConnection("Provider=Microsoft.ACE.Sql.12.0;Data Source=|DataDirectory|\PayrollManagerDB.accdb;Persist Security Info=False;")
            'con.Open()
            Dim cmd As New SqlCommand("SELECT Password FROM Users Where username = 'admin'", MyConnection)
