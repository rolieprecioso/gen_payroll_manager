...
Public Class frmEmployeeAttendanceRecord
    ...
    Sub fillcombo()
        ...
        Try
            ...
            adp.SelectCommand = New SqlCommand("SELECT distinct (employeeid) FROM employeeattendance", CN)
            ds = New DataSet("ds")
    ...
    Private Sub button4_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles button4.Click
        Try
            ...
            con = MyConnection
            'con.Open()
            cmd = New SqlCommand("select (WorkingDate) as [Working Date],(Status) as [Status], (InTime) as [In Time],(OutTime) as [Out Time],(Overtime) as [Overtime] from employeeAttendance where WorkingDate between '" & DateFrom.Text & "' And '" & DateTo.Text & "' and EmployeeId='" & EmployeeID.Text & "' order by workingdate", con)
