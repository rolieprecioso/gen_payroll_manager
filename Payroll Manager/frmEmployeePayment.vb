...
Public Class frmEmployeePayment
    ...
    Private Sub EmployeeID_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmployeeID.SelectedIndexChanged
        Try
            ...
            'End If
            'con.Open()
            cmd = New SqlCommand("select (Overtime) as [Overtime] from employeeAttendance where WorkingDate between '" & DateFrom.Value & "' And '" & DateTo.Value & "' and EmployeeId='" & EmployeeID.Text & "'", con)
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        Try
            ...
            con = MyConnection
            'con.Open()
            Dim ct As String = "select employeeid,paymentdate from employeepayment where employeeid='" & EmployeeID.Text & "' and paymentdate= " & PaymentDate.Value & ""
            ...
            Else
                ...
                cmd.Parameters.Add(New SqlParameter("@d3", SqlDbType.Int, 10, "amount"))
                cmd.Parameters.Add(New SqlParameter("@d4", SqlDbType.Int, 10, "deduction"))
                cmd.Parameters("@d1").Value = paymentdate.value
    ...
    Private Sub delete_records()
        Try
            ...
            cmd.Connection = con
            cmd.Parameters.Add(New SqlParameter("@DELETE1", SqlDbType.VarChar, 30, "PaymentID"))
