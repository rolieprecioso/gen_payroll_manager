...
Public Class frmAdvance
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        ...
        Try
            con = MyConnection
            'con.Open()
            Dim ct As String = "select employeeid,workingdate from AdvanceEntry where employeeid='" & EmployeeID.Text & "' and workingdate= '" & EntryDate.Value & "'"
            ...
            'con.Open()
            con = MyConnection
            Dim cb As String = "insert into advanceentry(workingdate,employeeid,amount,deduction) VALUES ('" & EntryDate.Value & "','" & EmployeeID.Text & "'," & Amount.Text & ",0)"
    ...
    Private Sub delete_records()
        Try
            ...
            cmd.Parameters.Add(New SqlParameter("@DELETE2", SqlDbType.VarChar, 30, "WorkingDate"))

            cmd.Parameters("@DELETE1").Value = Trim(EmployeeID.Text)

            cmd.Parameters("@DELETE2").Value = Trim(EntryDate.Value)
