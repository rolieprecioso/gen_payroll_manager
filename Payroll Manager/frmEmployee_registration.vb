...
Public Class frmEmployee_registration
    ...
    Private Sub Save_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Save.Click
        ...
        Try
            ...
            cmd.Parameters.Add(New SqlParameter("@d1", SqlDbType.Varchar, 30, "employeeid"))

            cmd.Parameters.Add(New SqlParameter("@d2", SqlDbType.VarChar, 100, "employeename"))

            cmd.Parameters.Add(New SqlParameter("@d3", SqlDbType.VarChar, 200, "address"))

            cmd.Parameters.Add(New SqlParameter("@d4", SqlDbType.Varchar, 10, "mobileno"))

            cmd.Parameters.Add(New SqlParameter("@d5", SqlDbType.Varchar, 60, "email"))

            cmd.Parameters.Add(New SqlParameter("@d6", SqlDbType.Varchar, 10, "bloodgroup"))

            cmd.Parameters.Add(New SqlParameter("@d7", SqlDbType.Varchar, 60, "department"))

            cmd.Parameters.Add(New SqlParameter("@d8", SqlDbType.Varchar, 60, "designation"))

            cmd.Parameters.Add(New SqlParameter("@d9", SqlDbType.Varchar, 30, "dateofjoining"))

            cmd.Parameters.Add(New SqlParameter("@d10", SqlDbType.Varchar, 10, "salary"))

            cmd.Parameters.Add(New SqlParameter("@d11", SqlDbType.Varchar, 10, "basicworkingtime"))
    ...
    Sub Filldepartment()
        Try
            ...
            Dim CN As SqlConnection = MyConnection
