...
Public Class frmEmployeesRecord
    ...
    Private Sub EmployeeName_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles EmployeeName.SelectedIndexChanged
        Try
            con = MyConnection
            'con.Open()
            cmd = New SqlCommand("select (EmployeeID) as [Employee ID], (EmployeeName) as [Employee Name],(Address) as [Address],(MobileNo) as [Mobile No],(Email) as [Email],(BloodGroup) as [Blood Group],(Department) as [Department],(Designation) as [Designation],(DateOfJoining) as [Date Of Joining],(Salary) as [Basic Salary],(BasicWorkingTime) as [Basic Working Time] from employeeregistration where Employeename = '" & EmployeeName.Text & "'", con)
    ...
    Sub fillcombo()
        ...
        Try
            ...
            adp.SelectCommand = New SqlCommand("SELECT distinct  (employeename) FROM employeeregistration", CN)
            ds = New DataSet("ds")
