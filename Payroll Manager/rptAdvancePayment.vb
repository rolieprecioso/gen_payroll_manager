...
Public Class rptAdvancePayment
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Payroll_Manager.rptAdvancePayment.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedrptAdvancePayment
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptAdvancePayment = New rptAdvancePayment()
        rpt.Site = Me.Site
        Return rpt
    End Function
